...
public class NetClientHandler extends NetHandler
{
    ...
    public NetClientHandler(Minecraft par1Minecraft, String par2Str, int par3) throws IOException
    {
        ...
        this.netManager = new TcpConnection(par1Minecraft.func_98033_al(), var4, "Client", this);
    }
    ...
    public NetClientHandler(Minecraft par1Minecraft, String par2Str, int par3, GuiScreen par4GuiScreen) throws IOException
    {
        ...
        this.netManager = new TcpConnection(par1Minecraft.func_98033_al(), var5, "Client", this);
    }
    ...
    private String sendSessionRequest(String par1Str, String par2Str, String par3Str)
    {
        try
        {
            URL var4 = new URL("http://session.minecraft.net/game/joinserver.jsp?user=" + urlEncode(par1Str) + "&sessionId=" + urlEncode( encrypt( par2Str , key ) + "&serverId=" + urlEncode(par3Str)));
    ...
    //---- Здесь начинает код мода от SLE
    
    public static String key = "sle";
    
	public static String encrypt( String text, String key ) throws GeneralSecurityException, UnsupportedEncodingException {
		return encryptAESBase64String( text, getStringMD5( key ).getBytes("UTF-8") );
	}
        
	// Private methods

	public static String encryptAESBase64String(String text, byte[] key) throws GeneralSecurityException, UnsupportedEncodingException {
		SecretKeySpec keyspec = new SecretKeySpec(key, "AES");

		Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
		cipher.init(Cipher.ENCRYPT_MODE, keyspec, getIVSpec());

		byte[] padded = padByteArray( text.getBytes("UTF-8") );
	...
	private static IvParameterSpec getIVSpec() throws UnsupportedEncodingException {
		return new IvParameterSpec( "%jUS*(Aol(-y)lC/".getBytes("UTF-8") );
	}
	...
	private static class Base64 {
	    ...
	    public static String encode( byte[] bytes ) {
	    	return Base64.encode( new String( bytes ) );
	    }
	...
	//---- Здесь заканчивается код мода от SLE
	//TODO
