...
public final class NetworkManager {
	 ...
	 * @throws IOException
	 */
	public static String sendPostRequest( URL requestURL, String data ) throws IOException {
	 ...
	 * @throws MalformedURLException
	 */
	public static String getServerLink( Engine engine ) throws MalformedURLException {
		URL url;
