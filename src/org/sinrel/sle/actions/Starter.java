...
//TODO Добавить параметр включения/выключения указывания абсолютного пути к Java
...
public abstract class Starter {
	...
	/**
	 * Возвращает количество оперативной памяти, которая будет выделена при запуске клиента.
	 * @return Количество выделяемой ОЗУ в МегаБайтах
	 */
	 ...
	 */
	public void setResourcePackDir( String resourcePacksDir ) {
		if( resourcePacksDir == null ) throw new NullPointerException("Служебная папка клиента не может быть NULL");
	 ...
	 * Если true, то будет использоваться переход в полноэкранный режим
 	 * @param useFullScreen
	 */
