 ...
 */
public class ExternalSecureClassLoader extends ClassLoader {
    /*
     ...
     */
    protected ExternalSecureClassLoader(ClassLoader parent)
    {
        super(parent);
     ...
     * @see SecurityManager#checkCreateClassLoader
     */
    protected ExternalSecureClassLoader()
    {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
     ...
     * <code>b.length</code>.
     *
     * @exception SecurityException if an attempt is made to add this class to a
