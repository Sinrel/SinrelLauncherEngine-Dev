 ...
 */
public class ExternalURLClassPath {
     ...
     * refer to a JAR file.
     *
     * @param urls the directory and JAR file URLs to search for classes and
     * resources
     * @param factory the URLStreamHandlerFactory to use when creating new URLs
     */
    public ExternalURLClassPath(URL[] urls, URLStreamHandlerFactory factory)
    {
    ...
    public ExternalURLClassPath(URL[] urls)
    {
        this(urls, null);
    }
    ...
    private static class Loader implements Closeable {
        ...
        URL findResource(final String name, boolean check)
        {
            ...
            try
            {
                if (check)
                {
                    ExternalURLClassPath.check(url);
                }
