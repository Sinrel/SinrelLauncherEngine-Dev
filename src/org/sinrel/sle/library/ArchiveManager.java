...
//TODO rename class name to "archivator"
/**
 * Class offer methods which need for archives unpacking. 
 * 
 * @since 2.0.0 build 4
 */
public final class ArchiveManager {
	 ...
	 public static void unpack( File inFile, File outFolder ) { 
		 try {  
	 ...
	 public static void removeAllArchiveFiles( File folder ) {
